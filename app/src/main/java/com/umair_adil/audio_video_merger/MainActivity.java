...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.umair_adil.audio_video_merger.R.layout.activity_main);
        this.context = MainActivity.this;

        filePaths = new ArrayList<String>();

        btn_append = (Button) findViewById(com.umair_adil.audio_video_merger.R.id.btn_append);
        btn_merge = (Button) findViewById(com.umair_adil.audio_video_merger.R.id.btn_merge);
        btn_pick = (Button) findViewById(com.umair_adil.audio_video_merger.R.id.btn_pick);
        btn_clear = (Button) findViewById(com.umair_adil.audio_video_merger.R.id.btn_clear);
        txt_output = (TextView) findViewById(com.umair_adil.audio_video_merger.R.id.textView1);
